...
def residuosUrbanosBio():
    ...
    ### ==== This will allow us to insert data into the Database =====####
    ...
    ### ====== this will return all the data from all periods === ####
    ...
    ### === this will return all data from a specific period === ####
    ...
    ##### ====== It will return all the keys only from NoSQL Database ===== ######
    ...
    st.markdown("<h1 style='text-align: center; color: grey;'>Deposição de residuos urbanos biodegradáveis (RUB) em aterro (%)</h1>",
